...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        String create_str = "CREATE TABLE "+TABLE_CONTACTS+"("+KEY_ID+" INTEGER PRIMARY KEY,"+KEY_NAME+" TEXT,"+KEY_PHONE_NUMBER+" TEXT"+")";
    ...
    public int getContactsCount(){
        String count_query = "SELECT * FROM "+TABLE_CONTACTS;
